...
if not defined VESTIGIA_MCP_ARCHIVE_WRITE_PREFIXES set "VESTIGIA_MCP_ARCHIVE_WRITE_PREFIXES=02_Journal,04_Payloads,06_Structures,07_Labs,08_Exports,10_Misc,Anima,Bubbles,Cow,Friction,Inkling,Isabel_and_Indexia,Jeff,Jeff_Prime,Kael,Liora,MB,Palim,Rain,Sable,Seryn,Sol,Sphinx,Viv"
...
if not defined VESTIGIA_MCP_GAMETABLE_ENABLED set "VESTIGIA_MCP_GAMETABLE_ENABLED=0"
...
echo   GameTable:  %VESTIGIA_MCP_GAMETABLE_ENABLED%
